...
Do \emph{not} avoid the issue by simply copying {\tt StdOut.java} into you current directory.
There are several suggestions for how to do this on the book website, under \emph{Web Resources, Code}.
