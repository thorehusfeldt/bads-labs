...
\begin{enumerate}
\item {\tt RandomQueue.java} 
\item  a short report covering:
  \begin{itemize}
  \item your design choices for the class and the iterator
  \item the tests you ran to convince yourself of the implementations correctness
  \item how the implementation faired on codeJudge
  \end{itemize}
...
Java classes than {\tt java.util.Iterator} and from {\tt import edu.princeton.cs.algs4} the classes {\tt StdIn, StdOut, StdRandom, StdStats}.
