...
\bigskip
\caption{A tiny evolving network. The \emph{nonisolated} event happens at $T=3$, the giant component emerges at $T=4$, and the whole network becomes connected at $T=6$.} 
\end{marginfigure}
